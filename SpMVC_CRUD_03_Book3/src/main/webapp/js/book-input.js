...
// let num2 = 20
// name = "홍길동" :
//		JS 표준에서는 사용할수 있는 문법이지만 가급적 사용 지양
...
$(function(){
	...
	$("#btn-save").click(function(){
		...
		if(isNaN(s_price)){
			...
			// 입력자의 입력을 도와주는 기능
			// 기존의 값을 삭제하고 다시 입력할때 편의를 주는기능
			// 입력박스에 담긴 값을 지워라
			// 보통 type="password"일 경우 사용
			//$("#b_price").val("")
			
			
			// 원래 입력된 text를 모두 감싸고 
			// 아무 글자나 입력하면 원래text가 지워지도록 하는 기능
			// 보통 type="text"일 경우 사용
			$("#b_price").select()
			$("#b_price").focus()
			return false;
		}
